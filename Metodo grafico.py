...
plt.contour(X, Y, restric1_valor, [0], colors='red', alpha=0.5, linewidths=2, label='X <= 20')
plt.contour(X, Y, restric2_valor, [0], colors='red', alpha=0.5, linewidths=2, label='Y <= 10')
plt.contour(X, Y, restric3_valor, [0, 100], colors='red', alpha=0.5, linewidths=2, label='3X + 4Y >= 12')

#Se coloca el punto de la solución óptima
optima_x = 20
optima_y = 10
optima_z = fo(optima_x, optima_y)
